...
output_image_path = "/home/orin_uav/main_ws/src/Test/random_zed_inference.jpg"
target_size = (1920, 1080)  # Resize
pose = []
rotation_mat = [2.34, 2.34, 0]
# ----------------------
...
def main():
    ...
    for box in results.boxes:
        ...
        # Append to pose
        if label == "Weed":
             pose.append([-x_coord/1000, -depth_z/1000, y_coord/1000, rotation_mat[0], rotation_mat[1], rotation_mat[2]])
             print (depth_text)
        else:
             print ("No weed")

    # Result
    cv2.imshow("YOLO + ZED Depth", frame_resized)
    cv2.waitKey(1)
